...
/** Implements geof:perimeter. */
public class PerimeterFF extends FunctionBase2 {

    @Override
    public NodeValue exec(NodeValue value, NodeValue units) {
        try {
            ...
            return NodeValue.makeDouble(geometry.perimeter(unitsURI));
        } catch (DatatypeFormatException | UnitsConversionException | UnitsURIException ex) {
